...
when a link or node ");
drawstring(-3.5,0.0,0.0," is carrying so much data that its quality of service
deteriorates.");
drawstring(-3.5,-0.5,0.0,"* Congestion control concerns controlling traffic
32 Dept. of Computer Science & Engineering.Congestion Control
entry into a ");
...
drawstring(-3.5,-3,0.0,"* It should not be confused with flow control, which
...
setFont(GLUT_BITMAP_TIMES_ROMAN_24);
glColor3f(0.0, 1.0, 1.0);
drawstring(-3.0,2.5,0.0,"Computer Graphics Mini Project on CONGESTION
CONTROL");
setFont(GLUT_BITMAP_TIMES_ROMAN_24);
glColor3f(0.0,1.0,1.0);
...
45 Dept. of Computer Science & Engineering.Congestion Control
setFont(GLUT_BITMAP_TIMES_ROMAN_24);
glColor3f(0.0,1.0,1.0);
...
46 Dept. of Computer Science & Engineering.Congestion Control
...
glutAddMenuEntry("About Project
